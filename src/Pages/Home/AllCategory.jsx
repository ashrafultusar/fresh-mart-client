...
import img8 from "../../assets/images/category-thumb-8.jpg"; 
import img9 from "../../assets/images/category-thumb-5.jpg"; 
import img10 from "../../assets/images/category-thumb-6.jpg"; 
import img11 from "../../assets/images/category-thumb-7.jpg"; 
import img12 from "../../assets/images/category-thumb-8.jpg"; 
    ...
    <div className="container mx-auto my-12 px-4">
      <div className=" flex justify-between items-center mb-16">
        ...
        <div className="flex items-center gap-2">
          <button
            ref={prevRef}
            className="bg-gray-200 py-3 px-5 rounded-md hover:bg-gray-300"
          >
            <FaArrowLeftLong />
          </button>
          <button
